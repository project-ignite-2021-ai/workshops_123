...
def NimSumStrat(piles):
    ...
    # Helpful Functions
    # nim_sum(arr): get the Nim Sum (as described in lecture or in 
    #      https://plus.maths.org/content/play-win-nim) of the array
    # isValidMove(piles, taken): determine if the tuple taken is valid
    # validMoves(piles): return a list of all valid moves
